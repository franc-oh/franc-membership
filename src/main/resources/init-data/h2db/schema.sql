...
CREATE TABLE TB_MY_MEMBERSHIP (
    ...
    MSP_GRADE_CD VARCHAR(10) Default 'COMMON' COMMENT '멤버십 등급코드',
...
/* seq - 바코드생성 시퀀스 */
CREATE SEQUENCE MEMBERSHIP.BARCODE_SEQ
START WITH 1
INCREMENT BY 1
MAXVALUE 999999
CYCLE;
...
CREATE ALIAS IF NOT EXISTS STR_TO_DATE FOR "com.franc.app.config.H2FunctionConfig.strToDate";
